...
import { Menu, X, Code, Star, Folder, Mail } from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    <nav className="fixed w-full top-0 left-0 bg-[#1a1a2e]  z-50 overflow-hidden">
      ...
      {isOpen && (
        <motion.div
          ...
          className="md:hidden bg-[#12122b] shadow-md shadow-purple-500/30 rounded-b-xl"
        >
